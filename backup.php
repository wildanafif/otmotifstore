  ...
  <header style="background-color:#fff;">
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="logo">vbInSight</div>
            </div>

            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li><a href="<?=base_url()?>" style="color:#000000;"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Beranda</a></li>
                ...
                <li >
                    ...
                    <?php } ?>
                    <li >
                        <a href="<?php echo site_url()?>iklan" > <i class="icon-white icon-plus">
   ...
   <div id="mainContainer" class="" style="width:100%;" >
